...
public class TestClass {
	...
	{
		service.createAccount("Hari", "9865485651",new BigDecimal(9000));
		service.createAccount("Amar", "9963242422",new BigDecimal(6000));
		Customer customer=service.createAccount("Shravya", "9922950519",new BigDecimal(7000));
...
*/
	...
	{
		service.showBalance("98654856512");		
	}
	...
	{
		Customer customer=service.showBalance("9865485651");
...
/*	@Test(expected=InsufficientBalanceException.class)
	...
	{
		service.fundTransfer("9865485651", "9963242422", new BigDecimal(12000));		
	}*/
	...
	{
		service.fundTransfer("9865485651", "9922950519", new BigDecimal(0));		
	}
	*/
	...
	{
		service.fundTransfer("9865485651", "", new BigDecimal(0));		
	}
	...
	*/
	...
	{
		Customer customer=service.fundTransfer("9865485651", "9922950519", new BigDecimal(550.50));
		BigDecimal expected=customer.getWallet().getBalance();
	...
	{
		Customer customer=service.fundTransfer("9865485651", "9922950519", new BigDecimal(15000));	
	}
	*/
...
/*	@Test(expected=InsufficientBalanceException.class)
	...
	{
		service.withdrawAmount("9865485651", new BigDecimal(0));
	}
